...
<img src="https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202501.png" alt="image-20231215111653457" style="zoom:50%;" />
...
<img src="https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202944.png" alt="image-20231215172420879" style="zoom:50%;" />
...
![image-20231219100708214](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202875.png)
...
![image-20231219100923120](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202889.png)
...
![image-20231219105650074](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202903.png)
...
![image-20231219220932088](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202340.png)

### 线程池状态

ThreadPoolExecutor 使用 int 的高 3 位来表示线程池状态，低 29 位表示线程数量

![image-20231219221009144](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202364.png)
...
![image-20231220105756413](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202379.png)
...
![image-20231220110558471](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202394.png)
...
![image-20231220153013638](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202407.png)
...
![image-20231220155409210](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202422.png)
...
![image-20231220160338091](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202827.png)
...
![image-20231221094204968](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202841.png)
...
![image-20231221095442890](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202858.png)

第一个竞争出现时：CAS 修改 state 失败，进入FIFO队列等待

![image-20231221095601204](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202872.png)
...
![image-20231221095650779](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202884.png)
...
![image-20231221095936151](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202899.png)

4. shouldParkAfterFailedAcquire 执行完毕回到 acquireQueued ，再次 tryAcquire 尝试获取锁，当然这时 state 仍为 1，失败
5. 当再次进入 shouldParkAfterFailedAcquire 时，这时因为其前驱 node 的 waitStatus 已经是 -1，这次返回 true
6. 进入 parkAndCheckInterrupt， Thread-1 park（灰色表示）

![image-20231221102544145](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202289.png)

再次有多个线程经历上述过程竞争失败，变成这个样子

![image-20231221102558350](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202305.png)
...
![image-20231221102621825](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202318.png)

当前队列不为 null，并且 head 的 waitStatus = -1，进入 unparkSuccessor 流程
找到队列中离 head 最近的一个 Node（没取消的），unpark 恢复其运行，本例中即为 Thread-1
回到 Thread-1 的 acquireQueued 流程

![image-20231221102655249](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202332.png)
...
![image-20231221150834559](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202346.png)
...
![image-20231221153058067](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202366.png)

4）t2 会看看自己的节点是不是老二，如果是，还会再次调用 tryAcquireShared(1) 来尝试获取锁

5）如果没有成功，在 doAcquireShared 内 for (;;) 循环一次，把前驱节点的 waitStatus 改为 -1，再 for (;;) 循环一次尝试 tryAcquireShared(1) 如果还不成功，那么在 parkAndCheckInterrupt() 处 park

![image-20231221153109887](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202747.png)

**（6）t3 r.lock，t4 w.lock**

这种状态下，假设又有 t3 加读锁和 t4 加写锁，这期间 t1 仍然持有锁，就变成了下面的样子

![image-20231221153154330](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202761.png)
...
![image-20231221153258083](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202778.png)
...
![image-20231221153410110](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202794.png)
...
![image-20231221153435614](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202807.png)

这回再来一次 for (;;) 执行 tryAcquireShared 成功则让读锁计数加一

这时 t3 已经恢复运行，接下来 t3 调用 setHeadAndPropagate(node, 1)，它原本所在节点被置为头节点

![image-20231221153516742](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202821.png)
...
![image-20231221153600513](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202201.png)

t3 进入 sync.releaseShared(1) 中，调用 tryReleaseShared(1) 让计数减一，这回计数为零了，进入 doReleaseShared() 将头节点从 -1 改为 0 并唤醒老二，即

![image-20231221153618984](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202216.png)

之后 t4 在 acquireQueued 中 parkAndCheckInterrupt 处恢复运行，再次 for (;;) 这次自己是老二，并且没有其他 竞争，tryAcquire(1) 成功，修改头结点，流程结束

![image-20231221153631882](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202233.png)
...
<img src="https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202247.png" alt="image-20231221170806944" style="zoom:50%;" />

假设其中 Thread-1，Thread-2，Thread-4 cas 竞争成功，而 Thread-0 和 Thread-3 竞争失败，进入 AQS 队列 park 阻塞

![image-20231221170702951](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202262.png)
...
![image-20231221170754665](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202276.png)
...
![image-20231221192635559](https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202708.png)
...
<img src="https://xiongyuqing-img.oss-cn-qingdao.aliyuncs.com/img/202312212202720.png" alt="image-20231221210726950" style="zoom:50%;" />
